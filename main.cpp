...
private:
	...
	static inline constexpr std::uint16_t O_ = 10000;
};
...
int main()
{
	...
	BigNum B("0010151683789593856926894729872875482798168735197489628548248972646275872649728467826498728642649828472987489628");
	BigNum C = A-B;
